...
class Individual
{
  ...
  * Note : this will follow 'id' attribute at 'User' entity
  */
  protected $id;
  ...
  * Note : Starting date of the user in FCL
  */
  protected $start_date;

  /**
  * @ORM\Column(type="string")
  * Note : Duration of user working as researcher before joining FCL
  */
  protected $before_fcl;

  /**
  * @ORM\Column(type="string")
  * Note : Bachelor, Master or PhD
  */
